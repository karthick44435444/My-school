          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="pt-2 flex items-center gap-3">
              <a
                ...
                aria-label="SchoolVajo on Instagram"
                className="group flex items-center gap-2 px-3 py-1.5 rounded-xl bg-gradient-to-r from-pink-500/10 via-purple-500/10 to-amber-500/10 hover:from-pink-500 hover:to-purple-600 text-pink-600 hover:text-white border border-pink-200/60 hover:border-transparent transition-all shadow-2xs font-bold text-xs"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="SchoolVajo on Facebook"
                className="group flex items-center gap-2 px-3 py-1.5 rounded-xl bg-blue-500/10 hover:bg-blue-600 text-blue-600 hover:text-white border border-blue-200/60 hover:border-transparent transition-all shadow-2xs font-bold text-xs"
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3 text-xs text-slate-500 font-medium">
              <li className="flex items-center gap-2.5">
                ...
                <a href="mailto:schoolvajo@gmail.com" className="hover:text-indigo-600 transition">
