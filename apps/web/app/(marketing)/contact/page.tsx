...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      setSubmitted(true);
      toast.success("Thank you! Your message has been sent successfully. Our team will reach out shortly.");
    }, 800);
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-2xl mx-auto mb-14 space-y-3">
            ...
            <h1 className="text-3xl sm:text-5xl font-extrabold text-slate-900 tracking-tight">
              Get in Touch with Our <span className="text-indigo-600">Campus Advisory</span>
            </h1>
            <p className="text-sm sm:text-base text-slate-600">
              Have questions regarding institution onboarding, pricing plans, or customized deployments? We are here to help.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            >
              ...
              <div className="rounded-3xl border border-slate-200/80 bg-white p-6 shadow-sm space-y-4">
                <h3 className="text-sm font-bold text-slate-900 uppercase tracking-wider">Direct Support Channels</h3>
                ...
                {submitted ? (
                  <div className="text-center py-12 space-y-4">
                    ...
                    <button
                      ...
                      onClick={() => {
                        setSubmitted(false);
                        setForm({ name: "", schoolName: "", email: "", phone: "", role: "ADMIN", message: "" });
                      }}
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="border-b border-slate-100 pb-4 mb-2">
                      ...
                      <p className="text-xs text-slate-500 mt-1">
                        Fill in your details below and our campus onboarding team will contact you.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      >
                        <option value="ADMIN">School Administrator / Trustee</option>
