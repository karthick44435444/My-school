...
import {
  ...
  Lock, ChevronRight, Edit3, X, Building2, ShieldCheck, KeyRound
} from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">
              {view === "password" ? "Security & Passwords" : "Principal Profile & Settings"}
            </h1>
            <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
              Manage your personal principal details and account security
            </p>
          </div>
        </div>
          ...
          <div className="w-full space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 outline-none text-sm focus:ring-2 focus:ring-blue-500"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-bold text-slate-600 uppercase tracking-wider mb-1.5">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-500">
                      Update your login password to ensure security
                    </div>
                  </div>
                </div>
            ...
            <div className="pt-2">
              ...
              >
                ...
                <span>Log Out of Principal Account</span>
              </button>
            </div>
          </div>
        )}
