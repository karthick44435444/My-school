...
export const TOUR_ITEMS: TourItem[] = [
  ...
  },
  {
    ...
    category: "admin",
    categoryLabel: "Communication & Admin",
    title: "Student Directory & Bulk Import",
    roleBadge: "Student Records",
    badgeColor: "bg-indigo-100 text-indigo-700 border-indigo-200",
    description: "Complete student record management with class/section filtering, profile photo uploads, parent linking, and bulk Excel/CSV onboarding.",
    features: [
      ...
      "Bulk student upload via Excel/CSV spreadsheet template",
    ],
    webImage: "/Tour/Web_Student_Lists.png",
    mobileImage: "/Tour/Mobile_Student_Lists.png",
    extraWebImage: "/Tour/Web_Bulk_Student_Upload.png",
    extraLabel: "Bulk Upload Interface",
